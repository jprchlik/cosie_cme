...
cmes['start_dt'] = cmes.t0-cmes.dt_limb
cmes['end_dt'] = cmes.t0+cmes.dt_cosf
...
#cmes = cmes[:3]
cmes['solar'] = sunpy.sun.solar_semidiameter_angular_size(i['start_dt']).value
...
#Caclculate the positin difference for said time
    ...
    #Assume everything is radial
    dx,dy,minv = np.sin(np.radians(
